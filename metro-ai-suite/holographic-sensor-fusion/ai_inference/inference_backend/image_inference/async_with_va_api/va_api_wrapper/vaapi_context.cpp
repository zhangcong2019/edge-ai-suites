...
VaApiContext::VaApiContext(hce::ai::inference::ContextPtr va_display_context)
    : _display_storage(va_display_context),
      _display(va_display_context->handle(hce::ai::inference::VAAPIContext::key::va_display)) {
