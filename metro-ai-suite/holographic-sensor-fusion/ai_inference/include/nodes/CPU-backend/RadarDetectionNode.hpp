...
#ifndef __RADAR_DETECTION_NODE_H_
#define __RADAR_DETECTION_NODE_H_
...
class RadarDetectionNode : public hva::hvaNode_t{
public:

    RadarDetectionNode(std::size_t totalThreadNum);

    virtual ~RadarDetectionNode() override;
...
class RadarDetectionNodeWorker : public hva::hvaNodeWorker_t{
public:
    RadarDetectionNodeWorker(hva::hvaNode_t* parentNode, RadarConfigParam m_radar_config);

    virtual ~RadarDetectionNodeWorker() override;
...
#endif /*__RADAR_DETECTION_NODE_H_*/
