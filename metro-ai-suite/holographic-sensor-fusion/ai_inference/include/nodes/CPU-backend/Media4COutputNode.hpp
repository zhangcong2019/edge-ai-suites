...
#ifndef HCE_AI_INF_MEDIA_4C_OUTPUT_NODE_HPP
#define HCE_AI_INF_MEDIA_4C_OUTPUT_NODE_HPP
...
#define MEDIA_4C_OUTPUT_NODE_INPORT_NUM 4
...
class HCE_AI_DECLSPEC Media4COutputNodeWorker : public hva::hvaNodeWorker_t {
  public:
    Media4COutputNodeWorker(hva::hvaNode_t *parentNode, const std::string &bufType);
...
class HCE_AI_DECLSPEC Media4COutputNode : public baseResponseNode {
  public:
    Media4COutputNode(std::size_t totalThreadNum);

    ~Media4COutputNode() = default;
...
#endif  // #ifndef HCE_AI_INF_MEDIA_4C_OUTPUT_NODE_HPP