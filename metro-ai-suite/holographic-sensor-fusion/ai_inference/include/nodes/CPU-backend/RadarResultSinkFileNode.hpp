...
#ifndef HCE_AI_INF_RADAR_RESULT_SINK_FILE_NODE_HPP
#define HCE_AI_INF_RADAR_RESULT_SINK_FILE_NODE_HPP
...
public:
    ...
    */
    bool saveResultsToFile(const unsigned frameId, const trackerOutput& pcl);
...
class HCE_AI_DECLSPEC RadarResultSinkFileNodeWorker : public hva::hvaNodeWorker_t{
public:
    RadarResultSinkFileNodeWorker(hva::hvaNode_t* parentNode, const std::string& bufType);
...
class HCE_AI_DECLSPEC RadarResultSinkFileNode : public baseResponseNode{
public:

    RadarResultSinkFileNode(std::size_t totalThreadNum);

    ~RadarResultSinkFileNode() = default;

    virtual std::shared_ptr<hva::hvaNodeWorker_t> createNodeWorker() const override; 

    virtual hva::hvaStatus_t configureByString(const std::string& config) override;

    virtual const std::string nodeClassName() const override{ return "RadarResultSinkFileNode";};
...
#endif //#ifndef HCE_AI_INF_RADAR_RESULT_SINK_FILE_NODE_HPP