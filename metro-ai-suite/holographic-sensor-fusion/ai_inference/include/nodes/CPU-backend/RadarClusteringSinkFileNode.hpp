...
#ifndef HCE_AI_INF_RADAR_CLUSTERING_SINK_FILE_NODE_HPP
#define HCE_AI_INF_RADAR_CLUSTERING_SINK_FILE_NODE_HPP
...
public:
    ...
    */
    bool saveResultsToFile(const unsigned frameId, const clusteringDBscanOutput& output);
...
class HCE_AI_DECLSPEC RadarClusteringSinkFileNodeWorker : public hva::hvaNodeWorker_t{
public:
    RadarClusteringSinkFileNodeWorker(hva::hvaNode_t* parentNode, const std::string& bufType);
...
private:
    boost::property_tree::ptree m_jsonTree,m_clusteringTree;
...
class HCE_AI_DECLSPEC RadarClusteringSinkFileNode : public baseResponseNode{
public:

    RadarClusteringSinkFileNode(std::size_t totalThreadNum);

    ~RadarClusteringSinkFileNode() = default;

    virtual std::shared_ptr<hva::hvaNodeWorker_t> createNodeWorker() const override; 

    virtual hva::hvaStatus_t configureByString(const std::string& config) override;

    virtual const std::string nodeClassName() const override{ return "RadarClusteringSinkFileNode";};
...
#endif //#ifndef HCE_AI_INF_RADAR_CLUSTERING_SINK_FILE_NODE_HPP