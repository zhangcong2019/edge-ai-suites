...
#ifndef HCE_AI_INF_RADAR_OUTPUT_NODE_HPP
#define HCE_AI_INF_RADAR_OUTPUT_NODE_HPP
...
class HCE_AI_DECLSPEC RadarOutputNodeWorker : public hva::hvaNodeWorker_t {
  public:
    RadarOutputNodeWorker(hva::hvaNode_t *parentNode, const std::string &bufType);
...
class HCE_AI_DECLSPEC RadarOutputNode : public baseResponseNode {
  public:
    RadarOutputNode(std::size_t totalThreadNum);

    ~RadarOutputNode() = default;
...
#endif  // #ifndef HCE_AI_INF_RADAR_OUTPUT_NODE_HPP