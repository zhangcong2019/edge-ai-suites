...
The Smart Tolling application uses AI-driven video analytics to automate vehicle tolling. It provides a modular architecture that integrates seamlessly with various input sources and leverages AI models to deliver accurate license plate recognition and vehicle tracking across multiple lanes.

By following this guide, you will learn how to:
- **Set up the sample application**: Use Docker Compose to quickly deploy the application in your environment.
- **Run a predefined pipeline**: Execute a pipeline to see smart tolling application in action.
...
2. **Run Predefined Pipelines**:
   - Start video streams to run license plate recognition and vehicle tracking pipelines:
     ```bash
     ./sample_start.sh
     ```
...
3. **View the Application Output**:
   ...
   - Log in with the following credentials:
     - **Username**: `admin`
     - **Password**: `admin`
   - Check under the Dashboards section for the Smart Tolling preloaded dashboard.
   - **Expected Results**: The dashboard displays real-time video streams with AI overlays showing license plate recognition across multiple lanes and tolling metrics.
...
- [Smart Tolling](./how-to-use-application.md)
...
1. **Changing the Host IP Address**
   ...
   - If you need to use a specific Host IP address instead of the one automatically detected during installation, you can explicitly provide it using the following command:
     ...
     Example:
     ```bash
     ./install.sh smart-tolling 192.168.1.100
     ```
