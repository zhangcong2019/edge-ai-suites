...
- Understand how to interact with the various components of the Loitering Detection Sample Application.
...
- **Grafana Dashboard**: In Grafana UI, the dashboard displays detected people and cars
