...
/**
 * @brief read content as char_buffer
 * @param fileName file path
 * @param buffer file content
 * @param buffLen file content length
*/
void readRawDataFromBinary(const std::string& fileName, char*& buffer, size_t& buffLen)
{
    std::fstream fs;
...
std::string parseAbsolutePath(std::string path) {
