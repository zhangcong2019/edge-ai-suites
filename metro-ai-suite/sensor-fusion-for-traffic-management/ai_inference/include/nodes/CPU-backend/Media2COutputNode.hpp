...
#ifndef HCE_AI_INF_MEDIA_2C_OUTPUT_NODE_HPP
#define HCE_AI_INF_MEDIA_2C_OUTPUT_NODE_HPP
...
#define MEDIA_2C_OUTPUT_NODE_INPORT_NUM 2
...
class HCE_AI_DECLSPEC Media2COutputNodeWorker : public hva::hvaNodeWorker_t {
  public:
    Media2COutputNodeWorker(hva::hvaNode_t *parentNode, const std::string &bufType);
...
class HCE_AI_DECLSPEC Media2COutputNode : public baseResponseNode {
  public:
    Media2COutputNode(std::size_t totalThreadNum);

    ~Media2COutputNode() = default;
...
#endif  // #ifndef HCE_AI_INF_MEDIA_2C_OUTPUT_NODE_HPP