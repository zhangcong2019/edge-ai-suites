...
#ifndef __HCE_AI_INF_CLASSIFICATION_NODE_HPP__
#define __HCE_AI_INF_CLASSIFICATION_NODE_HPP__

#include <map>
#include <string>

#include "modules/inference_util/classification/cls_post_impl.hpp"
...
class ClassificationNode : public baseImageInferenceNode{
public:

    ClassificationNode(std::size_t totalThreadNum);

    virtual ~ClassificationNode() override;
    ...
    */
    ...
    /**
    * @brief Constructs and returns a node worker instance: ClassificationNodeWorker.
    * @param void
    */
...
class ClassificationNodeWorker : public baseImageInferenceNodeWorker{
public:
    ClassificationNodeWorker(hva::hvaNode_t* parentNode,
                            InferenceProperty inferenceProperty,
                            ImageInferenceInstance::Ptr instance);

    virtual ~ClassificationNodeWorker() override;
...
#endif //#ifndef __HCE_AI_INF_CLASSIFICATION_NODE_HPP__