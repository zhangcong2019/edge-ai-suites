...
1. Clone the **Worker Safety Gear Detection** repository:

    ```bash
    git clone https://github.com/open-edge-platform/edge-ai-suites
    cd edge-ai-suites/manufacturing-ai-suite/worker-safety-gear-detection
    ```
...
**![Worker Safety Gear Detection Image](./images/worker-safety-dp.png)**
...
1. On the Setup a Deployment page, select the **worker_safety_gear_detection** package for the deployment from the list, and click **Next**. The Select a Profile step appears.
