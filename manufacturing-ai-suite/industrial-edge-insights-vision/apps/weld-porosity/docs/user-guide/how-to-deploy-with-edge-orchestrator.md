...
To deploy the **Weld Porosity Classification** Sample Application with the Edge Orchestrator, follow the steps described in this document.
...
1. Clone the **Weld Porosity Classification** repository:
...
The **Weld Porosity Classification** Sample Application is fully deployed when the applications become green and the status is shown as _Running_.
...
### Access the **Weld Porosity Classification** Sample Application
...
1. Follow the steps described in the **Weld Porosity Classification** [Documentation](<how-to-deploy-with-helm.md#run-multiple-ai-pipelines>) on usage of the application.
