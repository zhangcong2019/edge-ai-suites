...
from api.device_config import build_device_config_payload
from metrics import (
...
def get_device_config() -> dict:
    """Per-workload device configuration summary (rPPG / AI-ECG / mdpnp / 3D pose).

    Reads DEVICE_ENV_PATH (default /configs/device.env) and resolves each
    configured device (CPU/GPU/NPU/AUTO) to platform hardware details.
